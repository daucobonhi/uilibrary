...
local DragonLib = {}
function DragonLib:Notify(NotifyConfig)
...
function DragonLib:Start(GuiConfig)
    ...
    local Flags = DragonLib and DragonLib.Flags or {}
    ...
    DragonGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    DragonGui.Name = "DragonGui"
    DragonGui.Parent = CoreGui

    local ScreenFind = CoreGui:FindFirstChild(DragonGui.Name)
    if ScreenFind and ScreenFind ~= DragonGui then
        ScreenFind:Destroy()  
    end
    ...
    Main.Name = "Main"
    Main.Parent = DragonGui
    Main.Position = UDim2.new(0, (DragonGui.AbsoluteSize.X // 2 - Main.Size.X.Offset // 2), 0, (DragonGui.AbsoluteSize.Y // 2 - Main.Size.Y.Offset // 2))
